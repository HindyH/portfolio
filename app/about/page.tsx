...
const PARAGRAPHS = [
  ...
  "When people hear \"computer science and studio art,\" I often get a surprised look, as if the two don't belong together. I've never seen it that way. Writing code and making art both start with the same question: what do I want to bring into existence, and how do I get there? For me, that question, and the willingness to sit with it, test ideas, and revise until something works, is the throughline of everything I do.",
];
